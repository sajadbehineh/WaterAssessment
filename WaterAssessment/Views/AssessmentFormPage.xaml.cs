...
public sealed partial class AssessmentFormPage : Page
{
    ...
    protected override void OnNavigatedTo(NavigationEventArgs e)
    {
        ...
        // 1. بررسی اینکه آیا پارامتر ورودی معتبر است یا خیر
        if (e.Parameter is Assessment receivedAssessment)
        {
            // 2. دریافت لیست کامل کارمندان از دیتابیس
            // (این لیست برای پر کردن ComboBox افزودن نفر جدید در صفحه اصلی لازم است)
            List<Employee> allEmployees = LoadAllEmployees();

            // 3. مقداردهی اولیه ویومدل
            // ما Assessment دریافت شده و لیست کارمندان را به ویومدل می‌دهیم
            ViewModel = new AssessmentViewModel(receivedAssessment, allEmployees);
    ...
    {
        // اتصال به دیتابیس برای گرفتن لیست کارمندان
        try
        {
        ...
        {
            // اگر دیتابیس در دسترس نبود یا خطایی رخ داد، لیست خالی برگردان
    ...
    //    DistanceNumberBox.NumberFormatter = formatter;
    //    TotalDepthNumberBox.NumberFormatter=formatter;
    //    Rev02NumberBox.NumberFormatter=formatter;
    //    Rev06NumberBox.NumberFormatter=formatter;
    //    Rev08NumberBox.NumberFormatter=formatter;
    //}
    ...
    //public List<LocationViewModel> LocationsViewModel { get; set; } = new List<LocationViewModel>();
    ...
    //public ObservableCollection<AssessmentItem> AssessmentsViewModel { get; set; }
    ...
    //private async Task InitAssessmentItemList()
    //{
    //    PersianCalendar pc = new PersianCalendar();
    //    AssessmentsViewModel?.Clear();
    //    using var db = new WaterAssessmentContext();

    //    var assessmentViewModels = await db.Assessments
    //        .AsNoTracking()
    ...
    //                    !string.IsNullOrEmpty(pointPanelTextBox.Text))
    //                {
    //                    var pointValue = ToDoubleSafeHelper.ToDoubleSafe(pointPanelTextBox.Text);
    ...
    //{
    //    var allPanels = new List<StackPanel> { distancesPanel, depthsPanel, radianPanel };
    //    foreach (var panel in allPanels)
    //    {
    //        foreach (var tb in GetPanelTextBoxes(panel)) tb.Text = string.Empty;
    //    }
    //    totalFlowBox.Text = "0.000";
    //}
